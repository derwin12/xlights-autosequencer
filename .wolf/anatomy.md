...
- `effect_placer.py` — Effect placement engine — maps theme layers to power groups and timing tracks. (~44964 tok)
  ...
  - fn `_lighten_palette` L224-375 (~2193 tok)
  - fn `_apply_palette_target` L376-391 (~184 tok)
  - fn `restrain_palette` L392-405 (~197 tok)
  - fn `compute_music_sparkles` L406-428 (~279 tok)
  - fn `compute_duration_target` L429-452 (~270 tok)
  - fn `compute_scaled_fades` L453-477 (~222 tok)
  - fn `_build_effect_pool` L478-507 (~319 tok)
  - fn `derive_working_set` L508-589 (~1090 tok)
  - fn `select_from_working_set` L590-628 (~446 tok)
  - fn `_compute_fadeout_ms_for_final_section` L629-654 (~299 tok)
  - fn `place_effects` L655-1300 (~9590 tok)
  - fn `_select_groups_for_layer` L1301-1369 (~716 tok)
  - fn `_assign_layers_to_tiers` L1370-1401 (~381 tok)
  - fn `_place_effect_on_group` L1402-1567 (~2104 tok)
  - fn `_place_chase_across_groups` L1568-1645 (~848 tok)
  - fn `_place_radial_chase_on_subgroup` L1646-1705 (~630 tok)
  - fn `_substitute_bounding_box_effect` L1706-1726 (~243 tok)
  - fn `_substitute_beat_canvas_effect` L1727-1747 (~274 tok)
  - fn `_substitute_matrix_effect` L1748-1769 (~255 tok)
  - fn `_place_call_response` L1770-1847 (~919 tok)
